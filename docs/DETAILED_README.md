# Unschooling React - Detailed Documentation

This file preserves the **full original README** with in-depth setup, configuration, API, and deployment instructions.  
The root `README.md` has been simplified to stay short and act as the entry-point.
