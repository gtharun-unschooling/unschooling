...
Upload the updated metadata sheet with all 29 columns to Google Sheets
"""
...
def upload_updated_metadata():
    """Upload updated metadata to Google Sheets"""
...
if __name__ == '__main__':
    success = upload_updated_metadata()
