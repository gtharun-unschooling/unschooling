#!/usr/bin/env python3
"""
🇮🇳 Update Metadata for Indian Context
Update metadata sheet to reflect Indian household context and clear categorization
"""
...
def update_metadata_for_indian_context():
    """Update metadata sheet to reflect Indian household context"""
    
    print("🇮🇳 Updating Metadata for Indian Context")
    print("=" * 60)
...
if __name__ == '__main__':
    result = update_metadata_for_indian_context()
    if result:
