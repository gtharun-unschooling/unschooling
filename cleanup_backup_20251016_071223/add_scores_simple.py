...
"""
📊 Add Scores Simple
Add validation scores to Google Sheets using simple approach
"""
...
def add_scores_simple():
    """Add validation scores to Google Sheets using simple approach"""
    
    print("📊 Adding Scores Simple")
    print("=" * 60)
    ...
    try:
        ...
        # Add scores for each activity using the correct format
        for activity in activity_scores:
            ...
            # Use the correct update format with list of lists
            worksheet.update(f"{score_col_letter}{row_num}", [[score_text]])
