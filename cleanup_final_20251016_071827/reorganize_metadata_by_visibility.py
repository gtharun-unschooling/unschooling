#!/usr/bin/env python3
"""
Reorganize Metadata Sheet by Visibility
Green (Customer Visible) at top
Yellow (Conditional) in middle  
Red (Internal Only) at bottom
"""
...
def reorganize_metadata_by_visibility():
    """Reorganize metadata rows by visibility type"""
    
    print("🔧 Reorganizing metadata by visibility...")
    ...
    try:
        ...
        # 🟢 GREEN = Customer/Parent Visible (TOP)
        green_columns = [
        ...
        # 🔴 RED = Internal/Company Only (BOTTOM)
        red_columns = [
        ...
        print("✅ Metadata reorganized by visibility!")
...
if __name__ == "__main__":
    print("🔧 Reorganize Metadata by Visibility Tool")
    print("=" * 40)
    
    reorganize_metadata_by_visibility()
    
    print("\n✅ Metadata reorganized!")
    print("📊 Order: 🟢 Green (top) → 🟡 Yellow (middle) → 🔴 Red (bottom)")
