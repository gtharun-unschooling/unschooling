#!/usr/bin/env python3
"""
Move Supervision Level to Green (Customer Visible)
Parents need to know safety requirements
"""

import gspread
from gspread_formatting import *

def move_supervision_level_to_green():
    """Move Supervision Level from Red to Green section"""
    
    print("🔧 Moving Supervision Level to Green (Customer Visible)...")
    ...
    try:
        ...
        # 🟢 GREEN = Customer/Parent Visible (TOP) - Supervision Level added
        green_columns = [
            ...
            ['Supervision Level', 'Level of adult supervision needed (safety for parents)', 'High', 'Fixed values', '15 chars max', 'Safety guidance', 'Values: High, Medium, Low', 'Age-appropriate supervision', 'Pillar-specific safety needs', 'Text', 'Yes', '', 'Manual entry', 'As needed', 'Must prioritize safety'],
        ...
        # 🔴 RED = Internal/Company Only (BOTTOM) - Supervision Level removed
        red_columns = [
        ...
        print("✅ Supervision Level moved to Green (Customer Visible)!")
...
if __name__ == "__main__":
    print("🔧 Move Supervision Level to Green Tool")
    print("=" * 40)
    
    move_supervision_level_to_green()
    
    print("\n✅ Supervision Level moved to Green!")
    print("📊 Parents need to know safety requirements!")
