#!/usr/bin/env python3
"""
Move Setup Time and Topic Number to Green (Customer Visible)
These are important for parents to see
"""
...
def move_columns_to_green():
    """Move Setup Time and Topic Number from Red to Green section"""
    
    print("🔧 Moving Setup Time and Topic Number to Green (Customer Visible)...")
    ...
    try:
        ...
        # Define the new order: Column Name, Purpose, Examples, Format, Character Limit, Requirements, Validation Rules, Age Considerations, Pillar-Specific Notes, Data Type, Mandatory, Default Value, Source, Update Frequency, Quality Standards
        ...
        # 🟢 GREEN = Customer/Parent Visible (TOP) - Now includes Setup Time and Topic Number
        green_columns = [
            ...
            ['Setup Time', 'Time needed to prepare activity (important for parents)', '5 minutes', 'Time format', '20 chars max', 'Realistic setup estimate', 'Format: X minutes', 'Age-appropriate setup', 'Pillar-specific requirements', 'Text', 'Yes', '', 'Manual entry', 'As needed', 'Must be accurate'],
        ...
        # 🔴 RED = Internal/Company Only (BOTTOM) - Now excludes Setup Time and Topic Number
        red_columns = [
        ...
        # Combine all data in the new order: Header + Green + Yellow + Red
        all_data = [header_row] + green_columns + yellow_columns + red_columns
        
        # Clear existing data and update with reorganized structure
        ...
        print("✅ Setup Time and Topic Number moved to Green (Customer Visible)!")
...
if __name__ == "__main__":
    print("🔧 Move Columns to Green Tool")
    print("=" * 30)
    
    move_columns_to_green()
    
    print("\n✅ Columns moved to Green!")
    print("📊 Setup Time and Topic Number are now Customer Visible!")
